...
export default class MainMenuScene extends Phaser.Scene {
   ...
   hero:Phaser.Types.Physics.Arcade.SpriteWithDynamicBody;
    ...
    preload() {
      this.load.spritesheet('idle-e-spritesheet','assets/hero/iddle_aggro_E.png',{frameWidth:128, frameHeight:128});
      this.load.spritesheet('walk-e-spritesheet','assets/hero/iddle_aggro_E.png',{frameWidth:128, frameHeight:128});
    }
    create() {
        ...
        let hero =this.physics.add.sprite(200,200, 'idle-e-spritesheet', 0)
        this.anims.create({
            key:'idle-e-anim',
